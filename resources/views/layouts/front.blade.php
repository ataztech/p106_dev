        ...
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                <div class="login_cartoon">
                    <img src="{{url('/public/theme1/images/payment.png')}}">
                </div>
                <div class="login-page">
                    <div class="form">
                        <form id="user_detail" class="user_detail" method="POST" action="">
                            {{ csrf_field() }}
                            <h4>Payment</h4>
                            <input class="form-control" id="name" type="text" placeholder="Enter Name" name="name" value="{{ old('name') }}" autofocus/>
                            <input class="form-control" id="contact_no" type="text" placeholder="Enter Contact Number" name="contact_no" value="{{ old('contact_no') }}"/>
                            <input class="form-control" id="email" type="text" placeholder="Enter Email Id" name="email" value="{{ old('email') }}"/>
                            ...
                            <select class="form-control" id="validity" name="validity">
                               ...
                               {{-- <option value="June 2024">June 2024</option>
                                ...
                                <option value="June 2030">June 2030</option>
                                <option value="June 2031">June 2031</option>
                                <option value="June 2032">June 2032</option>--}}
                            </select>
                            <br>
                            <input class="form-control" id="amount" type="text" placeholder="Enter Amount" name="amount" value="{{ old('amount') }}"/>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                <div class="login_cartoon">
                    <br>
                    <img src="{{url('public/theme1/images/1.png')}}">
                </div>
                <div class="login-page">
                    <div class="form">
                        <form id="user_registration" class="user_registration" method="POST" action="{{--{{route('register')}}--}}">
                            {{--{{ csrf_field() }}--}}
                            <h4>Sign Up</h4>
                            <input class="form-control" id="name" type="text" placeholder="Enter Name" name="name" value="{{ old('name') }}" autofocus/>
                            <input class="form-control" id="mobile" type="text" placeholder="Enter Contact Number" name="mobile" value="{{ old('mobile') }}"/>
                            <input class="form-control" id="city" type="text" placeholder="Enter Your City" name="city" value="{{ old('city') }}"/>
                            {{--<input class="form-control" id="email" type="text" placeholder="Enter Email Id" name="email" value="{{ old('email') }}"/>--}}
                            <input class="form-control" id="pasword" type="password" placeholder="Enter Password" name="pasword" value="{{ old('password') }}"/>
                            <input class="form-control" id="confirm_password" type="password" placeholder="Confirm Password" name="confirm_password" value="{{ old('confirm_password') }}"/>
                            {{--<input class="form-control" id="city" type="text" placeholder="Enter Your City" name="city" value="{{ old('city') }}"/>
                            <input class="form-control" id="state" type="text" placeholder="Enter Your State" name="state" value="{{ old('state') }}"/>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                ...
                <div class="login-page">
                    <div class="form">
                        <form id="forgot_password_form" class="forgot_password_form" method="POST" action="{{--{{route('register')}}--}}">
                            {{--{{ csrf_field() }}--}}
                            <h4>Forgot Password</h4>
                            <input class="form-control" id="forgot_mobile" type="text" placeholder="Enter registered mobile number" name="forgot_mobile" value="{{ old('mobile') }}"/>
...
<script src="{{url('/public/theme1/')}}/js/jquery.validate.js"></script>
@yield('footer')
<script>
    $(function(){
