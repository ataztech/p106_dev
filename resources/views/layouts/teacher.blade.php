...
<html lang="en">
  <head>
   ...
   <body class="nav-md">
    ...
    {{--<script src="{{url('/')}}/public/backend/js/ckeditor4/plugins/uploadimage"></script>--}}
    {{--<script src="{{url('/')}}/public/backend/js/ckeditor4/plugins/uploadwidget"></script>--}}
    {{--<script src="{{url('/')}}/public/backend/js/ckeditor4/plugins/filebrowser.js"></script>--}}
    <!--notify-->
    <script src="{{url('/')}}/public/backend/js/pnotify.js"></script>
    {{--list js--}}
    <script src="{{url('/')}}/public/backend/js/list.min.js"></script>
@yield('footer')
  </body>
  <script>
