...
<ul class="breadcrumb">
    ...
    <li><a href="{{url('teacher/doubt/list')}}">Doubt</a></li>
</ul>
<div class="messaging">
    <div class="inbox_msg">
        ...
        <div class="mesgs">
            ...
            @if($doubt->status != 2)
            <div class="type_msg">
                <form action="{{url('/teacher/doubt/reply/'.$doubt->id)}}" method="post" enctype="multipart/form-data">
                    <div class="input_msg_write">
                        <textarea class="write_msg" id="reply" name="reply"></textarea>
