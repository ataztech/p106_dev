...
<ul class="breadcrumb">
    ...
    <li><a href="javascript:void(0)">Update Sales</a></li>
</ul>
<div class="">
<div class="row">
                      ...
                      <div class="col-md-6 center-margin">
                          <form id="update_counsellor_form" class="form-horizontal form-label-left" action="" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                  <label>Date</label>
                                  <input class="form-control" type="text" id="date" name="date" value="{{old('date',$update_sales_detail->date)}}">
                                  @if ($errors->has('date'))
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" id="customer_name" name="customer_name" value="{{old('customer_name',$update_sales_detail->customer_name)}}">
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" id="contact_no" name="contact_no" value="{{old('contact_no',$update_sales_detail->contact_no)}}">
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" id="booking_value" name="booking_value" value="{{old('booking_value',$update_sales_detail->booking_value)}}">
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" id="cash_submitted" name="cash_submitted" value="{{old('cash_submitted',$update_sales_detail->cash_submitted)}}">
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" id="first_installment" name="first_installment" value="{{old('first_installment',$update_sales_detail->first_installment)}}">
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" id="second_installment" name="second_installment" value="{{old('second_installment',$update_sales_detail->second_installment)}}">
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" id="second_installment_date" name="second_installment_date" value="{{old('second_installment_date',$update_sales_detail->second_installment_date)}}">
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" id="third_installment" name="third_installment" value="{{old('third_installment',$update_sales_detail->third_installment)}}">
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" id="third_installment_date" name="third_installment_date" value="{{old('third_installment_date',$update_sales_detail->third_installment_date)}}">
                              ...
                              <div class="form-group">
                                  ...
                                  <select class="form-control" id="counsellor_id" name="counsellor_id">
                                      ...
                                      @foreach($counsellors as $counsellor)
                                          <option value="{{$counsellor->id}}" @if($update_sales_detail->counsellor_id == $counsellor->id) selected @endif>{{$counsellor->counsellor_name}}</option>
                                      @endforeach
                                  </select>
                              ...
                              <div class="form-group">
                                  ...
                                  <select class="form-control" id="mode_of_payment" name="mode_of_payment">
                                      ...
                                      <option value="Cash" @if($update_sales_detail->mode_of_payment == 'Cash') selected @endif>Cash</option>
                                      <option value="Cheque" @if($update_sales_detail->mode_of_payment == 'Cheque') selected @endif>Cheque</option>
                                  </select>
                              ...
                              <div class="form-group">
                                  <label>Place</label>
                                  <input class="form-control" type="text" id="place" name="place" value="{{old('place',$update_sales_detail->place)}}">
                                  @if ($errors->has('place'))
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" id="cheque_status" name="cheque_status" value="{{old('cheque_status',$update_sales_detail->cheque_status)}}">
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" id="cheque_no" name="cheque_no" value="{{old('cheque_no',$update_sales_detail->cheque_no)}}">
