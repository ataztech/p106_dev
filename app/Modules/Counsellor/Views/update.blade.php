                      ...
                      <div class="col-md-6 pull-left">
                          <form id="update_counsellor_form" class="form-horizontal form-label-left" action="" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" id="counsellor_id" name="counsellor_id" value="{{old('counsellor_id',$counsellor->counsellor_id)}}">
                              ...
                              <div class="form-group">
                                  <label>Counsellor Mobile No (Enter password only if you want to change current password)</label>
