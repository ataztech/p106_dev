...
<ul class="breadcrumb">
    ...
    <li><a href="javascript:void(0)">Update Exam</a></li>
</ul>
<div class="">
<div class="row">
                      ...
                      <div class="col-md-6 center-margin">
                          <form class="form-horizontal form-label-left" action="" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" value="{{$exam->name}}" name="name">
                                  @if ($errors->has('name'))
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" type="text" value="{{$exam->exam_full_form}}" name="exam_full_form">
                              ...
                              <div class="form-group">
                                  <img src="{{url('').$exam->link.'thumb/'.$exam->image}}">
                              </div>
