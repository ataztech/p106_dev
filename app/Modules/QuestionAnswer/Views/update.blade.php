...
<div class="col-md-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Update Question And Answers</h2>
                      ...
                      <div class="center-margin">
                          <form class="form-horizontal form-label-left" action="" method="post" enctype="multipart/form-data">
                              ...
                              <div class="col-md-3 form-group">
                                  ...
                                  <select name="standard" id="standard" class="form-control" onchange="getSubjects()">
                                      @foreach($standards as $standard)
                                          <option value="{{$standard->id}}" @if($question_answer->topic->chapter->subject->standard->id == $standard->id) selected @endif>{{$standard->name}}</option>
                                      @endforeach
                                  </select>
                              </div>
                              <div class="col-md-3 form-group">
                            ...
                            <div class="col-md-6 form-group">
                                  <h4>Add Question</h4>
                                  <textarea contenteditable="true" id="editor_question" name="editor_question">{!! $question_answer->question !!}</textarea>
                              </div>
                              <div class="col-md-6 form-group">
                                  <h4>Answer Type</h4>
                                  <label for=""><input  type="radio" value="0" name="answer_type" id="answer_type" @if($question_answer->answer_type == 0) checked @endif>Single</label>
                                  <label for=""><input type="radio" value="1" name="answer_type" @if($question_answer->answer_type == 1) checked @endif>Multiple</label>
                              </div>
                            </div>
                              <div class="row">
                              <div class="col-md-6 form-group">
                                  <h4>Option 1</h4>
                                  <textarea contenteditable="true" id="editor_option1" name="editor_option1">{!! $question_answer->option_1 !!}</textarea>
                              </div>
                              <div class="col-md-6 form-group">
                                  <h4>Option 2</h4>
                                  <textarea contenteditable="true" id="editor_option2" name="editor_option2">{!! $question_answer->option_2 !!}</textarea>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-md-6 form-group">
                                  <h4>Option 3</h4>
                                  <textarea contenteditable="true" id="editor_option3" name="editor_option3">{!! $question_answer->option_3 !!}</textarea>
                              </div>
                              <div class="col-md-6 form-group">
                                  <h4>Option 4</h4>
                                  <textarea contenteditable="true" id="editor_option4" name="editor_option4">{!! $question_answer->option_4 !!}</textarea>
                              </div>
                                <div class="col-md-6 form-group">
                                  <h4>Option 5 (Optional)</h4>
                                  <textarea contenteditable="true" id="editor_option5" name="editor_option5">{!! $question_answer->option_5 !!}</textarea>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-md-6 form-group">
                                  <h4>Reason</h4>
                                  <textarea contenteditable="true" id="editor_reason" name="editor_reason">{!! $question_answer->reason !!}</textarea>
                              </div>
                              <div class="col-md-6 form-group">
                                  <h4>Correct Answer</h4>
                                  <select name="answer[]" multiple id="answer" class="form-control">
                                      <option value="1" @if(in_array('1',$correct_answers)) selected @endif>1</option>
                                      <option value="2" @if(in_array('2',$correct_answers)) selected @endif>2</option>
                                      <option value="3" @if(in_array('3',$correct_answers)) selected @endif>3</option>
                                      <option value="4" @if(in_array('4',$correct_answers)) selected @endif>4</option>
                                      <option value="5" @if(in_array('5',$correct_answers)) selected @endif>5</option>
                                  </select>
                              </div>
                            <div>
                                ...
                                <input type="hidden" name="" id="subject_id" value="{{$question_answer->topic->chapter->subject->id}}">
                                <input type="hidden" name="" id="chapter_id" value="{{$question_answer->topic->chapter->id}}">
                                <input type="hidden" name="" id="topic_id" value="{{$question_answer->topic_id}}">
        ...
        function getTopic()
        {
            ...
            $.ajax({
                ...
                success: function(result){
                    for(var i =0; i < result.length; i++)
                    {
                        var condition = $('#topic_id').val() == result[i].id ? 'selected' : '';
                        $('#topic').append('<option value="'+result[i].id+'" '+condition+'>'+result[i].name+'</option>');
                    }
                }});
        }
</script>
