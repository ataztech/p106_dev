...
<!--	<div class="container" id="c0">
	...
	<div class="container" id="c1" onclick="window.location='{{url('user/configure/save-stream/science')}}'">
		...
		<div class="story" id="s1">
			...
			<p> When compared to other main streams- Commerce and Arts, Science stream is a bit tough. Academically bright students won’t have much difficulty in facing the subjects present in this stream though. </p>
			</div>
		</div>
	</div><!--
...
<a href="{{url('/user/configure/class')}}" class="previous">&laquo; Previous</a>
