...
">Select Your Board</h1>
    ...
    <form action='{{url('user/configure/save-board')}}' id="form-board" class="text-center">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-6 text-left">
              ...
              <div class="col-md-6 col-sm-6 col-xs-6 text-right">
                <a href="javascript:void(0)" onclick="$('#form-board').submit()" class="pre_next"> {{Session::has('competitive_exam')?'Next':'Finish'}} <i class="fa fa-chevron-right"></i></a>
            </div>
        </div>
      </div>
  </div> 
