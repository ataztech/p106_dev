...
<ul class="breadcrumb">
    ...
    <li><a href="javascript:void(0)">Create Topic</a></li>
</ul>
<div class="">
<div class="row">
                      ...
                      <div class="col-md-6 center-margin">
                          <form class="form-horizontal form-label-left" action="" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                  ...
                                  <select name="subject" class="form-control" id="subject" onchange="getChapters()">
                                      @foreach($subjects as $subject)
                                          <option value="{{$subject->id}}">{{$subject->name}} ({{$subject->standard->name}} Standard)</option>
                                      @endforeach
                                  </select>
                              ...
                              <div class="form-group">
                                  ...
                                  <div>
                                  <input checked type="radio" name="related_with" value="0" @if(old('related_with') == 0) checked @endif>Question And Answers
                                  </div>
                                  <div>
                                  <input type="radio" name="related_with" value="1" @if(old('related_with') == 1) checked @endif>Videos
                                  </div>
                                  @if ($errors->has('name'))
                                      <span><strong class="text-danger">{{ $errors->first('name') }}</strong></span>
                                  @endif
