...
<div class="main_dash_right purple_color" id="result">
    ...
    <a href='javascript:void(0)' onclick="pauseSession()" style="float: right; "><i class="fa fa-pause"></i></a>
   ...
   <div class="qsn_bookmark">
    ...
    <div class="answer">
      <ul>
          <li class="option1" onclick="checkAnswer({{$question_answer->id}},1, this)"><span>A</span>{!!html_entity_decode($question_answer->option_1)!!}</li>
         <li class="option2" onclick="checkAnswer({{$question_answer->id}},2, this)"><span>B</span>{!!html_entity_decode($question_answer->option_2)!!}
             
         </li>
          <li class="option3" onclick="checkAnswer({{$question_answer->id}},3, this)"><span>C</span>{!!html_entity_decode($question_answer->option_3)!!}
         
          </li>
          <li class="option4" onclick="checkAnswer({{$question_answer->id}},4, this)"><span>D</span>{!!html_entity_decode($question_answer->option_4)!!}</li>
