...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item"><a href="{{url('user/learn/'.base64_encode($chapter_data->subject_id))}}" >{{$chapter_data->subject->name}}</a></li>
 ...
 @if(App\Modules\Learn\Models\QuestionReport::getTopicReport($topic->id)>=100)            
        ...
        <div class="col-md-6" onclick="javascript:window.location='{{url('user/learn/'.base64_encode($chapter_data->subject_id).'/topic/'.base64_encode($topic->chapter_id).'/test/'.base64_encode($topic->id))}}'">
          ...
          <div class="media chaptr_box">
              ...
              <p><span>{{App\Modules\Learn\Models\QuestionReport::getTopicReport($topic->id)>=100?100:App\Modules\Learn\Models\QuestionReport::getTopicReport($topic->id)}}%</span> Completed   &nbsp;&nbsp;&nbsp;<span>{{App\Modules\Learn\Models\QuestionReport::getAccuracyReport($topic->id)}}%</span> Accuracy</p></div>
